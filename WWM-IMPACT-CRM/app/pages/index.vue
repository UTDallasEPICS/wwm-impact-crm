<template>
  <!-- Loading State -->
  <div v-if="isPending" class="min-h-screen flex items-center justify-center bg-gray-50">
  ...
  <!-- Not Logged In -->
  <div v-else-if="!data?.session" class="min-h-screen flex items-center justify-center bg-gray-50">
    <div class="text-center">
  ...
  <div v-else class="min-h-screen bg-gray-50">
        ...
        <div class="flex justify-between items-center">
          ...
          <div class="flex items-center gap-4">
            ...
            <div class="text-right hidden sm:block">
              ...
              <p class="text-xs text-gray-500">Role: <span class="font-medium">Placeholder</span></p>
            </div>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="bg-white rounded-lg shadow p-6">
        <h3 class="text-lg font-semibold mb-4 text-gray-800">Session Information</h3>
        <div class="bg-gray-50 rounded p-4 overflow-x-auto">
          <pre class="text-xs text-gray-700">{{ session }}</pre>
        </div>
      </div>
    </main>
    ...
    <footer class="bg-white border-t mt-12">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <p class="text-center text-gray-500 text-sm">© 2024 WWM Impact CRM. All rights reserved.</p>
      </div>
    </footer>
  </div>
</template>
