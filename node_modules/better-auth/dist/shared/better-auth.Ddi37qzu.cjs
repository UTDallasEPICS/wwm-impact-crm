...
require('./better-auth.BxKoxSCD.cjs');
...
const hasPermission = async (input, ctx) => {
  let acRoles = { ...input.options.roles || statement.defaultRoles };
...
const createInvitation = (option) => {
  ...
  return middleware.createAuthEndpoint(
    ...
    async (ctx) => {
      ...
      if (!organizationId) {
        throw new betterCall.APIError("BAD_REQUEST", {
          message: schema.ORGANIZATION_ERROR_CODES.ORGANIZATION_NOT_FOUND
        });
      }
      ...
      if (!member) {
        throw new betterCall.APIError("BAD_REQUEST", {
          message: schema.ORGANIZATION_ERROR_CODES.MEMBER_NOT_FOUND
        });
      }
      ...
      if (!canInvite) {
        throw new betterCall.APIError("FORBIDDEN", {
          message: schema.ORGANIZATION_ERROR_CODES.YOU_ARE_NOT_ALLOWED_TO_INVITE_USERS_TO_THIS_ORGANIZATION
        });
      }
      ...
      if (member.role !== creatorRole && roles.split(",").includes(creatorRole)) {
        throw new betterCall.APIError("FORBIDDEN", {
          message: schema.ORGANIZATION_ERROR_CODES.YOU_ARE_NOT_ALLOWED_TO_INVITE_USER_WITH_THIS_ROLE
        });
      }
      ...
      if (alreadyMember) {
        throw new betterCall.APIError("BAD_REQUEST", {
          message: schema.ORGANIZATION_ERROR_CODES.USER_IS_ALREADY_A_MEMBER_OF_THIS_ORGANIZATION
        });
      }
      ...
      if (alreadyInvited.length && !ctx.body.resend) {
        throw new betterCall.APIError("BAD_REQUEST", {
          message: schema.ORGANIZATION_ERROR_CODES.USER_IS_ALREADY_INVITED_TO_THIS_ORGANIZATION
        });
      }
      ...
      if (pendingInvitations.length >= invitationLimit) {
        throw new betterCall.APIError("FORBIDDEN", {
          message: schema.ORGANIZATION_ERROR_CODES.INVITATION_LIMIT_REACHED
        });
      }
      if (ctx.context.orgOptions.teams && ctx.context.orgOptions.teams.enabled && typeof ctx.context.orgOptions.teams.maximumMembersPerTeam !== "undefined" && "teamId" in ctx.body && ctx.body.teamId) {
        ...
        for (const teamId of teamIds2) {
          ...
          if (!team) {
            throw new betterCall.APIError("BAD_REQUEST", {
              message: schema.ORGANIZATION_ERROR_CODES.TEAM_NOT_FOUND
            });
          }
          ...
          if (team.members.length >= maximumMembersPerTeam) {
            throw new betterCall.APIError("FORBIDDEN", {
              message: schema.ORGANIZATION_ERROR_CODES.TEAM_MEMBER_LIMIT_REACHED
            });
          }
        }
      }
...
const acceptInvitation = (options) => middleware.createAuthEndpoint(
  ...
  async (ctx) => {
    ...
    if (!invitation || invitation.expiresAt < /* @__PURE__ */ new Date() || invitation.status !== "pending") {
      throw new betterCall.APIError("BAD_REQUEST", {
        message: schema.ORGANIZATION_ERROR_CODES.INVITATION_NOT_FOUND
      });
    }
    if (invitation.email.toLowerCase() !== session.user.email.toLowerCase()) {
      throw new betterCall.APIError("FORBIDDEN", {
        message: schema.ORGANIZATION_ERROR_CODES.YOU_ARE_NOT_THE_RECIPIENT_OF_THE_INVITATION
      });
    }
    if (ctx.context.orgOptions.requireEmailVerificationOnInvitation && !session.user.emailVerified) {
      throw new betterCall.APIError("FORBIDDEN", {
        message: schema.ORGANIZATION_ERROR_CODES.EMAIL_VERIFICATION_REQUIRED_BEFORE_ACCEPTING_OR_REJECTING_INVITATION
      });
    }
    ...
    if (membersCount >= membershipLimit) {
      throw new betterCall.APIError("FORBIDDEN", {
        message: schema.ORGANIZATION_ERROR_CODES.ORGANIZATION_MEMBERSHIP_LIMIT_REACHED
      });
    }
    ...
    if (!acceptedI) {
      throw new betterCall.APIError("BAD_REQUEST", {
        message: schema.ORGANIZATION_ERROR_CODES.FAILED_TO_RETRIEVE_INVITATION
      });
    }
...
const rejectInvitation = (options) => middleware.createAuthEndpoint(
...
const cancelInvitation = (options) => middleware.createAuthEndpoint(
  ...
  async (ctx) => {
    ...
    if (!canCancel) {
      throw new betterCall.APIError("FORBIDDEN", {
        message: schema.ORGANIZATION_ERROR_CODES.YOU_ARE_NOT_ALLOWED_TO_CANCEL_THIS_INVITATION
      });
    }
    const organization = await adapter.findOrganizationById(
      invitation.organizationId
...
const getInvitation = (options) => middleware.createAuthEndpoint(
  ...
  async (ctx) => {
    ...
    if (!member) {
      throw new betterCall.APIError("BAD_REQUEST", {
        message: schema.ORGANIZATION_ERROR_CODES.INVITER_IS_NO_LONGER_A_MEMBER_OF_THE_ORGANIZATION
      });
    }
    return ctx.json({
      ...invitation,
...
const listInvitations = (options) => middleware.createAuthEndpoint(
...
const listUserInvitations = (options) => middleware.createAuthEndpoint(
    ...
    async (ctx) => {
      ...
      if (!orgId) {
        return ctx.json(null, {
          status: 400,
          body: {
            message: schema.ORGANIZATION_ERROR_CODES.NO_ACTIVE_ORGANIZATION
          }
        });
      }
...
const removeMember = (options) => middleware.createAuthEndpoint(
  ...
  async (ctx) => {
    ...
    if (isOwner) {
      if (member.role !== creatorRole) {
        throw new betterCall.APIError("BAD_REQUEST", {
          message: schema.ORGANIZATION_ERROR_CODES.YOU_CANNOT_LEAVE_THE_ORGANIZATION_AS_THE_ONLY_OWNER
        });
      }
    ...
    if (!canDeleteMember) {
      throw new betterCall.APIError("UNAUTHORIZED", {
        message: schema.ORGANIZATION_ERROR_CODES.YOU_ARE_NOT_ALLOWED_TO_DELETE_THIS_MEMBER
      });
    }
...
const updateMemberRole = (option) => middleware.createAuthEndpoint(
  ...
  async (ctx) => {
    ...
    if (!memberBelongsToOrganization) {
      throw new betterCall.APIError("FORBIDDEN", {
        message: schema.ORGANIZATION_ERROR_CODES.YOU_ARE_NOT_ALLOWED_TO_UPDATE_THIS_MEMBER
      });
    }
    const creatorRole = ctx.context.orgOptions?.creatorRole || "owner";
    ...
    if (updaterIsCreator && memberIsUpdatingThemselves) {
      ...
      if (owners.length <= 1 && !isSettingCreatorRole) {
        throw new betterCall.APIError("BAD_REQUEST", {
          message: schema.ORGANIZATION_ERROR_CODES.YOU_CANNOT_LEAVE_THE_ORGANIZATION_WITHOUT_AN_OWNER
        });
      }
    }
...
const getActiveMember = (options) => middleware.createAuthEndpoint(
...
const leaveOrganization = (options) => middleware.createAuthEndpoint(
  "/organization/leave",
  {
    method: "POST",
    body: z__namespace.object({
...
const listMembers = (options) => middleware.createAuthEndpoint(
  ...
  async (ctx) => {
    ...
    if (!isMember) {
      throw new betterCall.APIError("FORBIDDEN", {
        message: schema.ORGANIZATION_ERROR_CODES.YOU_ARE_NOT_A_MEMBER_OF_THIS_ORGANIZATION
      });
    }
...
const getActiveMemberRole = (options) => middleware.createAuthEndpoint(
...
const createOrganization = (options) => {
  ...
  const baseSchema = z__namespace.object({
    name: z__namespace.string().min(1).meta({
      description: "The name of the organization"
    }),
    slug: z__namespace.string().min(1).meta({
  ...
  return middleware.createAuthEndpoint(
    ...
    async (ctx) => {
      ...
      if (!canCreateOrg) {
        throw new betterCall.APIError("FORBIDDEN", {
          message: schema.ORGANIZATION_ERROR_CODES.YOU_ARE_NOT_ALLOWED_TO_CREATE_A_NEW_ORGANIZATION
        });
      }
      ...
      if (hasReachedOrgLimit) {
        throw new betterCall.APIError("FORBIDDEN", {
          message: schema.ORGANIZATION_ERROR_CODES.YOU_HAVE_REACHED_THE_MAXIMUM_NUMBER_OF_ORGANIZATIONS
        });
      }
      ...
      if (existingOrganization) {
        throw new betterCall.APIError("BAD_REQUEST", {
          message: schema.ORGANIZATION_ERROR_CODES.ORGANIZATION_ALREADY_EXISTS
        });
      }
      let {
...
const checkOrganizationSlug = (options) => middleware.createAuthEndpoint(
...
const updateOrganization = (options) => {
  ...
  return middleware.createAuthEndpoint(
    ...
    async (ctx) => {
      ...
      if (!member) {
        throw new betterCall.APIError("BAD_REQUEST", {
          message: schema.ORGANIZATION_ERROR_CODES.USER_IS_NOT_A_MEMBER_OF_THE_ORGANIZATION
        });
      }
      ...
      if (!canUpdateOrg) {
        throw new betterCall.APIError("FORBIDDEN", {
          message: schema.ORGANIZATION_ERROR_CODES.YOU_ARE_NOT_ALLOWED_TO_UPDATE_THIS_ORGANIZATION
        });
      }
...
const deleteOrganization = (options) => {
  return middleware.createAuthEndpoint(
    ...
    async (ctx) => {
      ...
      if (!canDeleteOrg) {
        throw new betterCall.APIError("FORBIDDEN", {
          message: schema.ORGANIZATION_ERROR_CODES.YOU_ARE_NOT_ALLOWED_TO_DELETE_THIS_ORGANIZATION
        });
      }
...
const getFullOrganization = (options) => middleware.createAuthEndpoint(
...
const listOrganizations = (options) => middleware.createAuthEndpoint(
  "/organization/list",
  {
    method: "GET",
    use: [schema.orgMiddleware, schema.orgSessionMiddleware],
  ...
  return middleware.createAuthEndpoint(
    ...
    async (ctx) => {
      ...
      if (session$1) {
        ...
        if (!canCreate) {
          throw new betterCall.APIError("FORBIDDEN", {
            message: schema.ORGANIZATION_ERROR_CODES.YOU_ARE_NOT_ALLOWED_TO_CREATE_TEAMS_IN_THIS_ORGANIZATION
          });
        }
      }
      ...
      if (maxTeamsReached) {
        throw new betterCall.APIError("BAD_REQUEST", {
          message: schema.ORGANIZATION_ERROR_CODES.YOU_HAVE_REACHED_THE_MAXIMUM_NUMBER_OF_TEAMS
        });
      }
...
const removeTeam = (options) => middleware.createAuthEndpoint(
  ...
  async (ctx) => {
    ...
    if (session$1) {
      ...
      if (!member || session$1.session?.activeTeamId === ctx.body.teamId) {
        throw new betterCall.APIError("FORBIDDEN", {
          message: schema.ORGANIZATION_ERROR_CODES.YOU_ARE_NOT_ALLOWED_TO_DELETE_THIS_TEAM
        });
      }
      ...
      if (!canRemove) {
        throw new betterCall.APIError("FORBIDDEN", {
          message: schema.ORGANIZATION_ERROR_CODES.YOU_ARE_NOT_ALLOWED_TO_DELETE_TEAMS_IN_THIS_ORGANIZATION
        });
      }
    }
    const team = await adapter.findTeamById({
    ...
    if (!ctx.context.orgOptions.teams?.allowRemovingAllTeams) {
      ...
      if (teams.length <= 1) {
        throw new betterCall.APIError("BAD_REQUEST", {
          message: schema.ORGANIZATION_ERROR_CODES.UNABLE_TO_REMOVE_LAST_TEAM
        });
      }
    }
    const organization = await adapter.findOrganizationById(organizationId);
...
const updateTeam = (options) => {
  ...
  return middleware.createAuthEndpoint(
    ...
    async (ctx) => {
      ...
      if (!member) {
        throw new betterCall.APIError("FORBIDDEN", {
          message: schema.ORGANIZATION_ERROR_CODES.YOU_ARE_NOT_ALLOWED_TO_UPDATE_THIS_TEAM
        });
      }
...
const listOrganizationTeams = (options) => middleware.createAuthEndpoint(
  ...
  async (ctx) => {
    ...
    if (!member) {
      throw new betterCall.APIError("FORBIDDEN", {
        message: schema.ORGANIZATION_ERROR_CODES.YOU_ARE_NOT_ALLOWED_TO_ACCESS_THIS_ORGANIZATION
      });
    }
    const teams = await adapter.listTeams(organizationId);
...
const setActiveTeam = (options) => middleware.createAuthEndpoint(
  ...
  async (ctx) => {
    ...
    if (!member) {
      throw new betterCall.APIError("FORBIDDEN", {
        message: schema.ORGANIZATION_ERROR_CODES.USER_IS_NOT_A_MEMBER_OF_THE_TEAM
      });
    }
    const updatedSession = await adapter.setActiveTeam(
      session.session.token,
...
const listUserTeams = (options) => middleware.createAuthEndpoint(
...
const listTeamMembers = (options) => middleware.createAuthEndpoint(
  ...
  async (ctx) => {
    ...
    if (!teamId) {
      throw new betterCall.APIError("BAD_REQUEST", {
        message: schema.ORGANIZATION_ERROR_CODES.YOU_DO_NOT_HAVE_AN_ACTIVE_TEAM
      });
    }
    const member = await adapter.findTeamMember({
      userId: session.user.id,
...
const addTeamMember = (options) => middleware.createAuthEndpoint(
  ...
  async (ctx) => {
    ...
    if (!canUpdateMember) {
      throw new betterCall.APIError("FORBIDDEN", {
        message: schema.ORGANIZATION_ERROR_CODES.YOU_ARE_NOT_ALLOWED_TO_CREATE_A_NEW_TEAM_MEMBER
      });
    }
...
const removeTeamMember = (options) => middleware.createAuthEndpoint(
  ...
  async (ctx) => {
    ...
    if (!canDeleteMember) {
      throw new betterCall.APIError("FORBIDDEN", {
        message: schema.ORGANIZATION_ERROR_CODES.YOU_ARE_NOT_ALLOWED_TO_REMOVE_A_TEAM_MEMBER
      });
    }
    const toBeAddedMember = await adapter.findMemberByOrgId({
      userId: ctx.body.userId,
...
Please refer to the documentation here: https://better-auth.com/docs/plugins/organization#dynamic-access-control`
        ...
        throw new betterCall.APIError("NOT_IMPLEMENTED", {
          message: schema.ORGANIZATION_ERROR_CODES.MISSING_AC_INSTANCE
        });
      }
      ...
      if (!organizationId) {
        ...
        throw new betterCall.APIError("BAD_REQUEST", {
          message: schema.ORGANIZATION_ERROR_CODES.YOU_MUST_BE_IN_AN_ORGANIZATION_TO_CREATE_A_ROLE
        });
      }
      ...
      if (!canCreateRole) {
        ...
        throw new betterCall.APIError("FORBIDDEN", {
          message: schema.ORGANIZATION_ERROR_CODES.YOU_ARE_NOT_ALLOWED_TO_CREATE_A_ROLE
        });
      }
      ...
      if (rolesInDB >= maximumRolesPerOrganization) {
        ...
        throw new betterCall.APIError("BAD_REQUEST", {
          message: schema.ORGANIZATION_ERROR_CODES.TOO_MANY_ROLES
        });
      }
  ...
  return middleware.createAuthEndpoint(
    ...
    async (ctx) => {
      ...
      if (!canDeleteRole) {
        ...
        throw new betterCall.APIError("FORBIDDEN", {
          message: schema.ORGANIZATION_ERROR_CODES.YOU_ARE_NOT_ALLOWED_TO_DELETE_A_ROLE
        });
      }
      if ("roleName" in ctx.body) {
        ...
        if (defaultRoles.includes(roleName)) {
          ...
          throw new betterCall.APIError("BAD_REQUEST", {
            message: schema.ORGANIZATION_ERROR_CODES.CANNOT_DELETE_A_PRE_DEFINED_ROLE
          });
        }
      }
      let condition;
      ...
      if (!existingRoleInDB) {
        ...
        throw new betterCall.APIError("BAD_REQUEST", {
          message: schema.ORGANIZATION_ERROR_CODES.ROLE_NOT_FOUND
        });
      }
  ...
  return middleware.createAuthEndpoint(
    ...
    async (ctx) => {
      ...
      if (!canListRoles) {
        ...
        throw new betterCall.APIError("FORBIDDEN", {
          message: schema.ORGANIZATION_ERROR_CODES.YOU_ARE_NOT_ALLOWED_TO_LIST_A_ROLE
        });
      }
  ...
  return middleware.createAuthEndpoint(
    ...
    async (ctx) => {
      ...
      if (!canListRoles) {
        ...
        throw new betterCall.APIError("FORBIDDEN", {
          message: schema.ORGANIZATION_ERROR_CODES.YOU_ARE_NOT_ALLOWED_TO_READ_A_ROLE
        });
      }
      let condition;
...
Please refer to the documentation here: https://better-auth.com/docs/plugins/organization#dynamic-access-control`
      ...
      if (!canUpdateRole) {
        ...
        throw new betterCall.APIError("FORBIDDEN", {
          message: schema.ORGANIZATION_ERROR_CODES.YOU_ARE_NOT_ALLOWED_TO_UPDATE_A_ROLE
        });
      }
      let condition;
      if ("roleName" in ctx.body) {
...
async function checkForInvalidResources({
  ...
  if (hasInvalidResource) {
    ...
    throw new betterCall.APIError("BAD_REQUEST", {
      message: schema.ORGANIZATION_ERROR_CODES.INVALID_RESOURCE
    });
  }
}
...
`,
    ...
    let errorMessage;
    if (action === "create")
      errorMessage = schema.ORGANIZATION_ERROR_CODES.YOU_ARE_NOT_ALLOWED_TO_CREATE_A_ROLE;
    else if (action === "update")
      errorMessage = schema.ORGANIZATION_ERROR_CODES.YOU_ARE_NOT_ALLOWED_TO_UPDATE_A_ROLE;
    else if (action === "delete")
      errorMessage = schema.ORGANIZATION_ERROR_CODES.YOU_ARE_NOT_ALLOWED_TO_DELETE_A_ROLE;
    else if (action === "read")
      errorMessage = schema.ORGANIZATION_ERROR_CODES.YOU_ARE_NOT_ALLOWED_TO_READ_A_ROLE;
    else if (action === "list")
      errorMessage = schema.ORGANIZATION_ERROR_CODES.YOU_ARE_NOT_ALLOWED_TO_LIST_A_ROLE;
    else
      errorMessage = schema.ORGANIZATION_ERROR_CODES.YOU_ARE_NOT_ALLOWED_TO_GET_A_ROLE;
    throw new betterCall.APIError("FORBIDDEN", {
...
async function checkIfRoleNameIsTakenByPreDefinedRole({
  ...
  if (defaultRoles.includes(role)) {
    ...
    throw new betterCall.APIError("BAD_REQUEST", {
      message: schema.ORGANIZATION_ERROR_CODES.ROLE_NAME_IS_ALREADY_TAKEN
    });
  }
}
...
const organization = (options) => {
  ...
  return {
    ...
    endpoints: {
      ...api,
      hasPermission: middleware.createAuthEndpoint(
    ...
    $ERROR_CODES: schema.ORGANIZATION_ERROR_CODES,
    options
  };
};
