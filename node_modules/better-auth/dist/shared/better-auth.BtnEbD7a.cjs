...
const cookieUtils = require('./better-auth.CqgkAe9n.cjs');
...
const sign = require('./better-auth.COF45WkB.cjs');
...
const oidcProvider = (options) => {
  ...
  return {
    ...
    endpoints: {
      getOpenIdConfig: middleware.createAuthEndpoint(
      ...
      oAuth2authorize: middleware.createAuthEndpoint(
        "/oauth2/authorize",
        {
          method: "GET",
      ...
      oAuthConsent: middleware.createAuthEndpoint(
        "/oauth2/consent",
        {
          method: "POST",
          body: z__namespace.object({
            accept: z__namespace.boolean(),
            consent_code: z__namespace.string().optional().nullish()
          }),
      ...
      oAuth2token: middleware.createAuthEndpoint(
        "/oauth2/token",
        {
          method: "POST",
      ...
      oAuth2userInfo: middleware.createAuthEndpoint(
        "/oauth2/userinfo",
        {
          method: "GET",
          metadata: {
       ...
       */
      registerOAuthApplication: middleware.createAuthEndpoint(
        "/oauth2/register",
        {
          method: "POST",
          body: z__namespace.object({
      ...
      getOAuthClient: middleware.createAuthEndpoint(
        "/oauth2/client/:id",
        {
          method: "GET",
          use: [session.sessionMiddleware],
